...
//! or async code. IDs are opaque stable strings; timestamps are RFC 3339 UTC
//! strings (`docs/api.md` §1) so the crate does not depend on a date library.
//!
...
mod tests {
    ...
    fn sample_model() -> Model {
        Model {
            ...
            mtime: "2026-08-01T12:00:00Z".into(),
    ...
    fn operation_error_carries_code_and_message() {
        let op = Operation {
            ...
            finished_at: Some("2026-08-01T12:00:09Z".into()),
